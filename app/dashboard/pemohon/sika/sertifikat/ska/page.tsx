...
import { Lock, CheckCircle, Plus, Trash2 } from 'lucide-react';
      ...
      <div className="px-6 py-6 space-y-4">
        ...
        <div className="bg-white rounded border-2 border-white shadow-lg overflow-hidden">
          ...
          <div className="flex border-t border-gray-200">
            ...
            <div style={{ flex: 3, backgroundColor: '#00b050', minHeight: '80px' }} className="flex items-center justify-center px-6 py-4">
          ...
          <div className="px-5 py-2.5 bg-blue-50 border-t border-blue-200 flex items-center justify-end gap-2">
            ...
            <span className="text-xs text-gray-500">0/0 item checklist terisi</span>
          </div>
