...
const checklistItems = [
  ...
  'Apakah peralatan yang akan dikerjakan sudah bebas dari gas-gas yang berbahaya dan bertekanan (dikosongkan, dipurging, disteam, diflushing, didisolasi)',
  ...
  'Kerangan dipasang kunci',
  'Apakah menggunakan bahan pembersih / bahan kimia yang mudah terbakar',
  'Apakah bekerja pada atau sekitar temperatur yang sangat tinggi atau sangat rendah',
  'Apakah bekerja menggunakan alat angkat / berat, bila YA pelaksana kerja harus meminta sertifikat kerja pengangkatan',
  'Apakah para pekerja memahami tindakan dalam keadaan darurat',
  'Apakah untuk pelaksanaan kerja dingin ini memerlukan sertifikat kerja spesifik lainnya, Jika YA maka sertifikat kerja dimaksud harus diminta terlebih dahulu',
];
...
export default function SKDPage() {
  ...
  const handleSimpan = () => {
    ...
    markSertifikatFilled('Sertifikat Kerja Dingin (SKD)');
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="bg-white border-b border-gray-200 px-6 py-4 flex items-center justify-between sticky top-0 z-10 shadow-sm">
        ...
        <div className="text-sm font-medium flex items-center gap-1">
          ...
          <span className="text-gray-400">&gt;</span>
          <span className="text-blue-800 font-semibold">SKD</span>
        </div>
      </div>
        ...
        <div className="fixed top-20 right-6 z-50 animate-slide-in">
          <div className="bg-green-50 border border-green-400 rounded-lg px-6 py-4 shadow-lg flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-green-600">Sertifikat Kerja Dingin (SKD) telah ditandai sebagai terisi.</p>
            </div>
          </div>
        </div>
      )}
      ...
      <div className="px-6 py-6 space-y-4">
        ...
        <div className="bg-white rounded border-2 border-blue-400 overflow-hidden">
          ...
          <div className="flex border-t border-gray-200">
            ...
            <div style={{ flex: 3, backgroundColor: '#0070c0', minHeight: '80px' }} className="flex items-center justify-center px-6 py-4">
              <h1 style={{ color: '#ffffff', fontWeight: 900, fontSize: '18px', letterSpacing: '0.12em', textTransform: 'uppercase', margin: 0 }}>
                Sertifikat Kerja Dingin
              </h1>
            </div>
        ...
        <div className="bg-white rounded border-2 border-blue-400 overflow-hidden divide-y divide-blue-200">
          ...
          <div className="flex border-t-2 border-blue-400">
            ...
            <div className="flex-1 flex items-center justify-center px-5 py-3 border-l border-r border-blue-400" style={{ backgroundColor: '#ffffff' }}>
            ...
            <div className="flex-1 flex items-center justify-center px-5 py-3 border-r border-blue-400" style={{ backgroundColor: '#92d050' }}>
              <span className="text-xs font-bold" style={{ color: '0000000' }}>Hijau Sebagai Arsip HSE</span>
            </div>
