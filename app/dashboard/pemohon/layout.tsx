...
import { Menu, X, Home, FileText, ClipboardList, Shield, Activity, ChevronRight, LogOut, Settings, Bell } from 'lucide-react';
...
const navItems = [
  ...
  },
  {
    section: 'LAYANAN',
    items: [
      { icon: Shield, label: 'Job Safety Analysis', href: '/dashboard/pemohon/jsa/new' },
      { icon: Activity, label: 'Monitoring Aktivitas', href: '#' },
    ],
  },
];
