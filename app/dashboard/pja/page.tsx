...
export default function DashboardPJA() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      {/* ─── HEADER (disamakan dengan Pemberi) ─── */}
      ...
      >
        ...
        <div style={{
          ...
          <p className="text-white" style={{ fontSize: '1.50rem', opacity: 0.92, marginBottom: '24px' }}>
            Kelola review dan approval JSA di sini.
          </p>
          <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', gap: '20px', flexWrap: 'wrap', justifyContent: 'center' }}>
            ...
            <button
              onClick={() => router.push('/dashboard/pja/audit_trailpersetujuan')}
              style={{
                padding: '12px 36px',
                borderRadius: '9999px',
      ...
      {/* ─── FOOTER (disamakan dengan Pemberi) ─── */}
