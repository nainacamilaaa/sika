...
import { Menu, X, Home, FileText, CheckCircle, ClipboardList, Shield, ChevronRight, LogOut, Settings, Bell } from 'lucide-react';
  ...
  return (
    <div style={{ minHeight: '100vh' }}>
      ...
      <style>{`
        ...
        .pemberi-nav-scroll::-webkit-scrollbar-thumb { background: rgba(255,255,255,0.10); border-radius: 10px; }
        .pemberi-nav-scroll::-webkit-scrollbar-thumb:hover { background: rgba(255,255,255,0.18); }
