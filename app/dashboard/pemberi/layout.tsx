...
const navItems = [
  ...
  },
  {
    section: 'PERSETUJUAN',
    items: [
      { icon: CheckCircle, label: 'Approval JSA', href: '/dashboard/pemberi/approval-jsa' },
      { icon: FileText, label: 'Approval Detail', href: '/dashboard/pemberi/approval-detail' },
    ],
  },
  {
    section: 'REVIEW',
    items: [
      { icon: Shield, label: 'Review JSA', href: '/dashboard/pemberi/review-jsa' },
      { icon: ClipboardList, label: 'Data Management', href: '/dashboard/pemberi/data-management' },
    ],
  },
];
